        ...
        <section>
            <div className="row" style={{paddingTop: "50px", paddingBottom: "20px"}}>
                <div className="col centerText">
                    ...
                    <h1 className="ourFont fontSize40" style={{fontWeight: "bold"}}>All organizations should make a move towards cloud communications. Here’s why:</h1>
                </div>
            </div>
            <div className="row" style={{paddingBottom: "30px", paddingTop: "20px"}}>
                ...
                <div className="col-md-6 mobileJourneyPad centerText">
                    <div style={{paddingLeft: "30px", paddingRight: "30px", display: "flex", alignItems: "center", flexDirection: "column"}}>
                            <div className="journeyIconDiv">
                        ...
                        <p className="ourFont fontSiz16">Quick turnaround uses <br /> your SIP trunks to create <br /> more SIP trunks.</p>
                    </div>
                </div>
                <div className="col-md-6 mobileJourneyPad centerText">
                    <div style={{paddingLeft: "30px", paddingRight: "30px", display: "flex", alignItems: "center", flexDirection: "column"}}>
                        ...
                        <p className="ourFont fontSiz16">SimplyVoysis also offers <br /> international numbers.</p>
                    </div>
                </div>
